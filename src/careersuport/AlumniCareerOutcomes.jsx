...
import { Globe, Briefcase, Handshake } from "lucide-react";
import CountUp from "react-countup";
import { motion } from "framer-motion";
import { useInView } from "react-intersection-observer";

export default function AlumniCareerOutcomes() {
  ...
  return (
    <section ref={ref} className="relative py-20 bg-white">
      ...
      {/* Stats Section */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 text-center gap-8 relative">
        {/* 1st (Now Globe) */}
        <motion.div
